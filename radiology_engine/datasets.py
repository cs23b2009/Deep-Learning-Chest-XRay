...
def normalize(img, maxval, reshape=False):
    ...
    Call re.utils.normalize moving forward.
    """
    return re.utils.normalize(img, maxval, reshape)
...
class MergeDataset(Dataset):
    ...
    .. code-block:: python
        ...
        dmerge = re.datasets.MergeDataset([dataset1, dataset2, ...])
        # Output:
...
class SubsetDataset(Dataset):
    ...
    .. code-block:: python
        ...
        dsubset = re.datasets.SubsetDataset(dataset, [0, 5, 60])
        # Output:
    ...
    .. code-block:: python
        ...
        dsubset = re.datasets.SubsetDataset(dataset, idxs)
        # Output:
...
class VinBrain_Dataset(Dataset):
    ...
    .. code-block:: python
        ...
        d_vin = re.datasets.VinBrain_Dataset(
            imgpath=".../train",
            csvpath=".../train.csv"
        )
...
class CovariateDataset(Dataset):
    ...
    .. code-block:: python
        ...
        d = re.datasets.CovariateDataset(
    ...
    The class re.datasets.CovariateDataset takes two datasets and two arrays
