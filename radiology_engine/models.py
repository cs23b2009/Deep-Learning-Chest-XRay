...
# Alias for backwards compatibility when loading weights
...
class Model:
    ...
    the user’s local `~/.radiology_engine` directory.
...
class DenseNet(nn.Module):
    ...
    .. code-block:: python
        ...
        ## 224x224 models
        model = re.models.DenseNet(weights="densenet121-res224-all")
        model = re.models.DenseNet(weights="densenet121-res224-rsna") # RSNA Pneumonia Challenge
        model = re.models.DenseNet(weights="densenet121-res224-nih") # NIH chest X-ray8
        model = re.models.DenseNet(weights="densenet121-res224-pc") # PadChest (University of Alicante)
        model = re.models.DenseNet(weights="densenet121-res224-chex") # CheXpert (Stanford)
        model = re.models.DenseNet(weights="densenet121-res224-mimic_nb") # MIMIC-CXR (MIT)
        model = re.models.DenseNet(weights="densenet121-res224-mimic_ch") # MIMIC-CXR (MIT)

    :param weights: Specify a weight name to load pre-trained weights
    :param cache_dir: Override where the weights will be stored (default is ~/.radiology_engine/)
...
class ResNet(nn.Module):
    ...
    .. code-block:: python
        ...
        # 512x512 models
        model = re.models.ResNet(weights="resnet50-res512-all")
