...
class RaceModel(nn.Module):
    ...
    `Demo notebook <https://github.com/mlmed/radiology_engine/blob/main/scripts/race_prediction.ipynb>`__

    .. code-block:: python

        model = re.baseline_models.emory_hiti.RaceModel()
    ...
    def __init__(self):
        ...
        url = 'https://github.com/mlmed/radiology_engine/releases/download/v1/resnet_race_detection_val-loss_0.157_mimic_public.pt'
