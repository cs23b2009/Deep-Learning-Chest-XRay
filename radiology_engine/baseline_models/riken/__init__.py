...
class AgeModel(nn.Module):
    ...
    `Demo notebook <https://github.com/mlmed/radiology_engine/blob/main/scripts/cxr_age_prediction.ipynb>`__

    .. code-block:: python

        model = re.baseline_models.riken.AgeModel()
    ...
    def __init__(self):
        ...
        url = "https://github.com/mlmed/radiology_engine/releases/download/v1/baseline_models_riken_xray_age_every_model_age_senet154_v2_tl_26_ft_7_fp32.pt"
