...
class PSPNet(nn.Module):
    ...
    You can load pretrained anatomical segmentation models. `Demo Notebook <https://github.com/mlmed/radiology_engine/blob/main/scripts/segmentation.ipynb>`_

    .. code-block:: python

        seg_model = re.baseline_models.chestx_det.PSPNet()
    ...
    params:
        cache_dir (str): Override directory used to store cached weights (default: ~/.radiology_engine/)
    ...
    def __init__(self, cache_dir:str = None):
        ...
        url = "https://github.com/mlmed/radiology_engine/releases/download/v1/pspnet_chestxray_best_model_4.pth"
